...
/*Sai
 * Example 3 is the one being used in this code
 * We are reading from a property file 
 * task:So try to write code to read from our mysql database and write into a property file
 */
public class PropertyExamples {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            writer.write("_=id:Integer,name:String,geom:Point,srval:Integer");
            writer.newLine();
            writer.write("fid1=1|jody garnett|POINT(0 0)|5");
            writer.newLine();
            writer.write("fid2=2|brent|POINT(10 10)|4");
            writer.newLine();
            writer.write("fid3=3|dave|POINT(20 20)|3");
            writer.newLine();
            writer.write("fid4=4|justin deolivera|POINT(30 30)|2");
            writer.newLine();
            writer.close();
    ...
    private static void example3(File tmp) throws IOException {
        System.out.println("example3 start\n");
        // example3 start
        Map<String, Serializable> params = new HashMap<String, Serializable>();
        params.put("directory", directory);
        DataStore datastore = DataStoreFinder.getDataStore(params);
        PropertyDataStore ds = new PropertyDataStore(directory);
        String name = "example";
        Query query = new Query("example");
        FeatureReader<SimpleFeatureType, SimpleFeature> reader = ds.getFeatureReader(name);
    //    FeatureReader<SimpleFeatureType, SimpleFeature> reader = datastore
        ...
        try {
            ...
            while (reader.hasNext()) {
                ...
                System.out.println(feature.getAttribute("srval"));
                count++;
            }
